...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 分类修改
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <select name="cate_pid">
                            <option value="0">==最高级分类==</option>
                            @foreach($data as $d)
                            <option name='cate_id' value="{{$d->cate_id}}"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span><i class="fa fa-exclamation-circle yellow">分类排序必须填写</i></span>
                    </td>
                </tr>
                <tr>
                    <th></th>
